...
exports.login = (req, res) => {
  var redirectUrl =
    ...
    "://localhost:" +
    port +
    "/auth/v3/oauth/authorize?type=workspace&redirect_uri=" +
...
exports.authorize = (req, res) => {
  var redirectUrl =
    req.protocol + "://localhost:" + port + "/auth/sign-in.html?type=workspace";
...
exports.signin = (req, res) => {
  var redirectUrl =
    ...
    "://localhost:" +
    port +
    "/auth/sign-in.html?error&type=workspace";
...
exports.version = (req, res) => {
  ...
  if (userName) {
    ...
    fs.readFile(
      path.join(__dirname, "../../../ui-assets/wwe/version.json"),
      { encoding: "utf8" },
      (err, data) => {
        if (err) {
